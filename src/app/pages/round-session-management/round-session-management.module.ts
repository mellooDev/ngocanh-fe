...
import { RoundSessionManagementComponent } from './round-session-management.component';


@NgModule({
  declarations: [
    RoundSessionManagementComponent,
  ],
  imports: [
    CommonModule,
    TreeModule,
    ...
    RouterModule.forChild([
      {
        path: '',
        component: RoundSessionManagementComponent,
      },
...
export class RoundSessionManagementModule { }
