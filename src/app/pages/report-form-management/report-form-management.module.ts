...
import { ReportFormManagementComponent } from './report-form-management.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([
      {
        path: '',
        component: ReportFormManagementComponent,
      },
...
export class ReportFormManagementModule { }
