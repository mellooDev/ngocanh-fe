...
import { AssignArgumentManagementComponent } from './assign-argument-management.component';
...
@NgModule({
  declarations: [
    AssignArgumentManagementComponent
  ],
  imports: [
    CommonModule,
    TreeModule,
    ...
    RouterModule.forChild([
      {
        path: '',
        component: AssignArgumentManagementComponent,
      },
...
export class AssignArgumentManagementModule { }
